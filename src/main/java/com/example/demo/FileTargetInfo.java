...
public class FileTargetInfo implements Serializable{
	...
	private final Logger logger = LoggerFactory.getLogger(FileTargetInfo.class);
    ...
    private void initInfo(FileInfo fileInfo){
        ...
        logger.info("blobSize>>>>>" + blobSize + ">>>fileSize>>>>" + fileSize + ">>>indexEnd>>>" + indexEnd + ">>>indexStart>>>" +indexStart);
